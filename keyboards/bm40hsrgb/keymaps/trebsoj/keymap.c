...
[2] = LAYOUT_planck_mit(
    ...
    KC_TRNS, LCTL(KC_A), LCTL(KC_S),    LCTL(KC_D), KC_NO,        KC_NO,      KC_CIRC,     KC_P4,    KC_P5,    KC_P6,    KC_PMNS, LALT(KC_ENT),
    KC_TRNS, KC_NO,      LCTL(KC_X),    KC_NO,      KC_NO,        KC_NO,      KC_NO,       KC_P1,    KC_P2,    KC_P3,    KC_PAST, KC_TRNS,
    KC_TRNS, KC_TRNS,    KC_TRNS,       MO(4),      KC_TRNS,      KC_TRNS,                 KC_P0,    KC_PDOT,  KC_COMM,  KC_PSLS, KC_EQL
),
/* RGB */
[3] = LAYOUT_planck_mit(
